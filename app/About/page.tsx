export default function AboutPage() {
  const schemaData = {
    ...
    "@type": "Organization",
    name: "akashbit International",
    url: "https://theskitbit.com",
    logo: "https://theskitbit.com/logo.png",
    description:
      "akashbit International is a 3D product animation agency serving clients in Miami, Los Angeles, New York, Canada, and the UK.",
    sameAs: ["https://www.instagram.com/skitbit", "https://www.linkedin.com/company/skitbit"],
    address: {
      "@type": "PostalAddress",
  ...
  return (
    <>
      ...
      <section className="relative bg-black text-white py-20 px-6 md:px-12 lg:px-20 text-center">
        <h1 className="text-4xl md:text-6xl font-bold mb-6">About akashbit International</h1>
      ...
      <section className="py-20 bg-black text-center text-white px-6">
        ...
        <p className="text-lg opacity-80 mb-8">Let akashbit International bring your products to life.</p>
        <a
          href="/contact"
